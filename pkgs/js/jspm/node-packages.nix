...
let
  sources = {
    ...
    "@jspm/generator-2.4.2" = {
      ...
      version = "2.4.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@jspm/generator/-/generator-2.4.2.tgz";
        sha512 = "7K7ls0lJZNP+JIoUxaCrzrgcvUrIUeg04lEAuJ6CpyBgf7akBB+JJMIq9OUbDGRFEHKPTHeP+ISyaeRwATVi0A==";
      };
    };
