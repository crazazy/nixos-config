...
let
  sources = {
    ...
    "@jspm/generator-2.6.2" = {
      ...
      version = "2.6.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@jspm/generator/-/generator-2.6.2.tgz";
        sha512 = "ZwrIK4hSSrXlRnXhEHW6v0DJxZcKRej1HgoQtfycrtXnQH7hf0i84xrTRC0x03tkYVYfzGddcnSB+wN0Qz3+oA==";
      };
    };
