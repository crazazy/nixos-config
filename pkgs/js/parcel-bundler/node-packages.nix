...
let
  sources = {
    ...
    "posthtml-parser-0.5.1" = {
      ...
      version = "0.5.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/posthtml-parser/-/posthtml-parser-0.5.1.tgz";
        sha512 = "NvSWOfgRDubv+RkaJv01JvpE2Q1ufcjzSwEGzjT15UYWhiM4kzpiQhAvL/Mkqc3zqZCOLgmxLZQ7Jlt3V75t0w==";
      };
    };
