...
let
  sources = {
    ...
    "electron-to-chromium-1.3.613" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.3.613";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.613.tgz";
        sha512 = "c3gkahddiUalk7HLhTC7PsKzPZmovYFtgh+g3rZJ+dGokk4n4dzEoOBnoV8VU8ptvnGJMhrjM/lyXKSltqf2hQ==";
      };
    };
    "elliptic-6.5.3" = {
      name = "elliptic";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.3.613"
