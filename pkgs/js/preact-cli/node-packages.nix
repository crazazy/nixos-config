...
let
  sources = {
    ...
    "preact-10.25.3" = {
      ...
      version = "10.25.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/preact/-/preact-10.25.3.tgz";
        sha512 = "dzQmIFtM970z+fP9ziQ3yG4e3ULIbwZzJ734vaMVUTaKQ2+Ru1Ou/gjshOYVHCcd1rpAelC6ngjvjDXph98unQ==";
      };
    };
